...
type GlobalVerificationTests (output:ITestOutputHelper) =
    ...
    member this.``Verify that all paths return a value`` () = 
        ...
        this.Expect "NotAllPathsReturnValue11" [Error ErrorCode.MissingReturnOrFailStatement]
        this.Expect "NotAllPathsReturnValue12" [Error ErrorCode.MissingReturnOrFailStatement]
    ...
    member this.``Return from within qubit allocation scopes`` () = 
        ...
        this.Expect "ReturnFromWithinUsing6"             []
        this.Expect "ReturnFromWithinUsing7"             [Warning WarningCode.UnreachableCode]
        this.Expect "ReturnFromWithinUsing8"             []
        this.Expect "ReturnFromWithinUsing9"             [Warning WarningCode.UnreachableCode; Warning WarningCode.UnreachableCode]
        this.Expect "ReturnFromWithinUsing10"            []
        ...
        this.Expect "InvalidReturnFromWithinUsing5"      [Error ErrorCode.InvalidReturnWithinAllocationScope; Warning WarningCode.UnreachableCode]
        this.Expect "InvalidReturnFromWithinUsing6"      [Error ErrorCode.InvalidReturnWithinAllocationScope]
        this.Expect "InvalidReturnFromWithinUsing7"      [Error ErrorCode.InvalidReturnWithinAllocationScope; Error ErrorCode.InvalidReturnWithinAllocationScope]
        this.Expect "InvalidReturnFromWithinUsing8"      [Error ErrorCode.InvalidReturnWithinAllocationScope]
        this.Expect "InvalidReturnFromWithinUsing9"      [Error ErrorCode.InvalidReturnWithinAllocationScope; Error ErrorCode.InvalidReturnWithinAllocationScope; Error ErrorCode.InvalidReturnWithinAllocationScope; Warning WarningCode.UnreachableCode]
        this.Expect "InvalidReturnFromWithinUsing10"     [Error ErrorCode.InvalidReturnWithinAllocationScope; Warning WarningCode.UnreachableCode]
        this.Expect "InvalidReturnFromWithinUsing11"     [Error ErrorCode.InvalidReturnWithinAllocationScope; Warning WarningCode.UnreachableCode]
        this.Expect "InvalidReturnFromWithinUsing12"     [Error ErrorCode.InvalidReturnWithinAllocationScope; Warning WarningCode.UnreachableCode]
        ...
        this.Expect "ReturnFromWithinBorrowing6"         []
        this.Expect "ReturnFromWithinBorrowing7"         [Warning WarningCode.UnreachableCode]
        this.Expect "ReturnFromWithinBorrowing8"         []
        this.Expect "ReturnFromWithinBorrowing9"         [Warning WarningCode.UnreachableCode; Warning WarningCode.UnreachableCode]
        this.Expect "ReturnFromWithinBorrowing10"        []
        ...
        this.Expect "InvalidReturnFromWithinBorrowing5"  [Error ErrorCode.InvalidReturnWithinAllocationScope; Warning WarningCode.UnreachableCode]
        this.Expect "InvalidReturnFromWithinBorrowing6"  [Error ErrorCode.InvalidReturnWithinAllocationScope]
        this.Expect "InvalidReturnFromWithinBorrowing7"  [Error ErrorCode.InvalidReturnWithinAllocationScope]
        this.Expect "InvalidReturnFromWithinBorrowing8"  [Error ErrorCode.InvalidReturnWithinAllocationScope]
        this.Expect "InvalidReturnFromWithinBorrowing9"  [Error ErrorCode.InvalidReturnWithinAllocationScope; Error ErrorCode.InvalidReturnWithinAllocationScope; Error ErrorCode.InvalidReturnWithinAllocationScope; Warning WarningCode.UnreachableCode]
        ...
        this.Expect "InvalidReturnFromWithinBorrowing11" [Error ErrorCode.InvalidReturnWithinAllocationScope; Warning WarningCode.UnreachableCode]
        this.Expect "InvalidReturnFromWithinBorrowing12" [Error ErrorCode.InvalidReturnWithinAllocationScope; Warning WarningCode.UnreachableCode]
        this.Expect "InvalidReturnFromWithinBorrowing13" [Error ErrorCode.InvalidReturnWithinAllocationScope; Warning WarningCode.UnreachableCode; Warning WarningCode.UnreachableCode]
        this.Expect "InvalidReturnFromWithinBorrowing14" [Error ErrorCode.InvalidReturnWithinAllocationScope; Warning WarningCode.UnreachableCode]
        ...
        this.Expect "ValidReturnPlacement16"             []
