...
namespace Ubiquity.NET.Llvm.Values
{
        ...
        : Constant
    {
        ...
        {
            get => ( Visibility )ValueHandle.Visibility;
            set => LLVM.SetVisibility( ValueHandle, ( LLVMVisibility )value );
        }

        /// <summary>Gets or sets the linkage specification for this symbol</summary>
        public Linkage Linkage
        {
            get => ( Linkage )ValueHandle.Linkage;
            set => LLVM.SetLinkage( ValueHandle, ( LLVMLinkage )value );
        }
        ...
        {
            get => ( UnnamedAddressKind )LLVM.GetUnnamedAddress( ValueHandle );
            set => LLVM.SetUnnamedAddress( ValueHandle, ( LLVMUnnamedAddr )value );
        }

        /// <summary>Gets a value indicating whether this is a declaration</summary>
        public bool IsDeclaration => ValueHandle.IsDeclaration;

        /// <summary>Gets the Module containing this global value</summary>
        public BitcodeModule ParentModule => NativeType.Context.GetModuleFor( ValueHandle.GlobalParent );
