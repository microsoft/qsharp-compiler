    ...
    */
        ...
        , IAttributeAccessor
    {
        ...
        public IFunctionType Signature
        {
            get
            {
                LLVMTypeRef ty = ValueHandle.TypeOf;
        ...
        {
            get => ( CallingConvention )ValueHandle.FunctionCallConv;
            set
            {
                var val = ValueHandle;
        ...
        public uint IntrinsicId => ValueHandle.IntrinsicID;
        ...
        public bool Verify( ) => ValueHandle.VerifyFunction( LLVMVerifierFailureAction.LLVMReturnStatusAction );
        ...
        {
            LLVMBasicBlockRef firstBlock = ValueHandle.FirstBasicBlock;
            BasicBlock retVal;
            ...
            {
                var blockRef = NativeType.Context.ContextHandle.InsertBasicBlock( firstBlock, name );
        ...
        {
            LLVM.AppendExistingBasicBlock( ValueHandle, block.BlockHandle );
        }
        ...
        {
            LLVMBasicBlockRef blockRef = NativeType.Context.ContextHandle.AppendBasicBlock( ValueHandle, name );
        ...
        public BasicBlock InsertBasicBlock( string name, BasicBlock insertBefore )
        {
            ...
            LLVMBasicBlockRef basicBlockRef = NativeType.Context.ContextHandle.InsertBasicBlock( insertBefore.BlockHandle, name );
        ...
        public unsafe void AddAttributeAtIndex( FunctionAttributeIndex index, AttributeValue attrib )
        {
            ...
            LLVM.AddAttributeAtIndex( ValueHandle, ( uint )index, attrib.NativeAttribute );
        }

        /// <inheritdoc/>
        public uint GetAttributeCountAtIndex( FunctionAttributeIndex index )
        {
            return ValueHandle.GetAttributeCountAtIndex( ( LLVMAttributeIndex )index );
        }
        ...
        public IEnumerable<AttributeValue> GetAttributesAtIndex( FunctionAttributeIndex index )
        {
            ...
            var buffer = ValueHandle.GetAttributesAtIndex( ( LLVMAttributeIndex )index );
        ...
        {
            var handle = LLVM.GetEnumAttributeAtIndex( ValueHandle, ( uint )index, kind.GetEnumAttributeId( ) );
        ...
        {
            LLVM.RemoveEnumAttributeAtIndex( ValueHandle, ( uint )index, kind.GetEnumAttributeId( ) );
        }
