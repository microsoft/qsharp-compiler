...
namespace Ubiquity.NET.Llvm
{
        ...
        IBitcodeModuleFactory
    {
        ...
        public ITypeRef VoidType => TypeRef.FromHandle(LLVM.VoidTypeInContext(this.ContextHandle))!;
        ...
        public ITypeRef Int16Type => TypeRef.FromHandle(LLVM.Int16TypeInContext(this.ContextHandle))!;

        /// <summary>Gets the LLVM 32 bit integer type for this context.</summary>
        public ITypeRef Int32Type => TypeRef.FromHandle(LLVM.Int32TypeInContext(this.ContextHandle))!;

        /// <summary>Gets the LLVM 64 bit integer type for this context.</summary>
        public ITypeRef Int64Type => TypeRef.FromHandle(LLVM.Int64TypeInContext(this.ContextHandle))!;

        /// <summary>Gets the LLVM 128 bit integer type for this context.</summary>
        public ITypeRef Int128Type => TypeRef.FromHandle(LLVM.Int128TypeInContext(this.ContextHandle))!;

        /// <summary>Gets the LLVM half precision floating point type for this context.</summary>
        public ITypeRef HalfFloatType => TypeRef.FromHandle(LLVM.HalfTypeInContext(this.ContextHandle))!;

        /// <summary>Gets the LLVM single precision floating point type for this context.</summary>
        public ITypeRef FloatType => TypeRef.FromHandle(LLVM.FloatTypeInContext(this.ContextHandle))!;

        /// <summary>Gets the LLVM double precision floating point type for this context.</summary>
        public ITypeRef DoubleType => TypeRef.FromHandle(LLVM.DoubleTypeInContext(this.ContextHandle))!;

        /// <summary>Gets the LLVM token type for this context.</summary>
        public ITypeRef TokenType => TypeRef.FromHandle(LLVM.TokenTypeInContext(this.ContextHandle))!;

        /// <summary>Gets the LLVM Metadata type for this context.</summary>
        public ITypeRef MetadataType => TypeRef.FromHandle(LLVM.MetadataTypeInContext(this.ContextHandle))!;

        /// <summary>Gets the LLVM X86 80-bit floating point type for this context.</summary>
        public ITypeRef X86Float80Type => TypeRef.FromHandle(LLVM.X86FP80TypeInContext(this.ContextHandle))!;

        /// <summary>Gets the LLVM 128-Bit floating point type.</summary>
        public ITypeRef Float128Type => TypeRef.FromHandle(LLVM.FP128TypeInContext(this.ContextHandle))!;
        ...
        public ITypeRef GetIntType(uint bitWidth)
        {
            ...
            return bitWidth switch
            {
                ...
                64 => this.Int64Type,
                128 => this.Int128Type,
                _ => TypeRef.FromHandle(LLVM.IntTypeInContext(this.ContextHandle, bitWidth))!,
            };
        }
        ...
        public IFunctionType GetFunctionType(ITypeRef returnType, params ITypeRef[] args)
            => this.GetFunctionType(returnType, args, false);
        ...
        {
            if (this.ContextHandle != returnType.Context.ContextHandle)
            {
                throw new ArgumentException();
            }
        ...
        public Constant CreateConstantStruct(bool packed, params Constant[] values)
            => this.CreateConstantStruct(packed, (IEnumerable<Constant>)values);
        ...
        public Constant CreateConstantStruct(bool packed, IEnumerable<Constant> values)
        {
            ...
            {
                var handle = LLVM.ConstStructInContext(this.ContextHandle, (LLVMOpaqueValue**)pValueHandles, (uint)valueHandles.Length, packed ? 1 : 0);
        ...
        {
            return this.CreateNamedConstantStruct(type, (IEnumerable<Constant>)values);
        }
        ...
        {
            var handle = LLVM.StructCreateNamed(this.ContextHandle, name.AsMarshaledString());
        ...
        public IStructType CreateStructType(bool packed, params ITypeRef[] elements)
        {
            ...
            fixed (LLVMTypeRef* pLlvmArgs = llvmArgs.AsSpan())
            {
                var handle = LLVM.StructTypeInContext(this.ContextHandle, (LLVMOpaqueType**)pLlvmArgs, (uint)llvmArgs.Length, packed ? 1 : 0);
                return TypeRef.FromHandle<IStructType>(handle);
            }
        }
        ...
        public IStructType CreateStructType(string name, bool packed, params ITypeRef[] elements)
            => this.CreateStructType(name, packed, (IEnumerable<ITypeRef>)elements);
        ...
        {
            var retVal = TypeRef.FromHandle<IStructType>(LLVM.StructCreateNamed(this.ContextHandle, name.AsMarshaledString()));
        ...
        /// </remarks>
        public ConstantDataArray CreateConstantString(string value) => this.CreateConstantString(value, true);
        ...
        {
            var handle = LLVM.ConstInt(
                this.BoolType.GetTypeRef(),
        ...
        {
            var handle = LLVM.ConstInt(this.Int8Type.GetTypeRef(), constValue, 0);
            return Value.FromHandle<ConstantInt>(handle)!;
        }
        ...
        {
            var handle = LLVM.ConstInt(this.Int8Type.GetTypeRef(), (ulong)constValue, 1);
            return Value.FromHandle<ConstantInt>(handle)!;
        }
        ...
        {
            var handle = LLVM.ConstInt(this.Int16Type.GetTypeRef(), (ulong)constValue, 1);
            return Value.FromHandle<ConstantInt>(handle)!;
        }
        ...
        {
            var handle = LLVM.ConstInt(this.Int16Type.GetTypeRef(), constValue, 0);
            return Value.FromHandle<ConstantInt>(handle)!;
        }
        ...
        {
            var handle = LLVM.ConstInt(this.Int32Type.GetTypeRef(), (ulong)constValue, 1);
            return Value.FromHandle<ConstantInt>(handle)!;
        }
        ...
        {
            var handle = LLVM.ConstInt(this.Int32Type.GetTypeRef(), constValue, 0);
            return Value.FromHandle<ConstantInt>(handle)!;
        }
        ...
        {
            var handle = LLVM.ConstInt(this.Int64Type.GetTypeRef(), (ulong)constValue, 1);
            return Value.FromHandle<ConstantInt>(handle)!;
        }
        ...
        {
            var handle = LLVM.ConstInt(this.Int64Type.GetTypeRef(), constValue, 0);
            return Value.FromHandle<ConstantInt>(handle)!;
        }
        ...
        {
            var intType = this.GetIntType(bitWidth);
            return this.CreateConstant(intType, constValue, signExtend);
        }
        ...
        public ConstantFP CreateConstant(float constValue)
            => Value.FromHandle<ConstantFP>(LLVM.ConstReal(this.FloatType.GetTypeRef(), constValue))!;

        /// <summary>Creates a constant floating point value for a given value.</summary>
        /// <param name="constValue">Value to make into a <see cref="ConstantFP"/>.</param>
        /// <returns>Constant value.</returns>
        public ConstantFP CreateConstant(double constValue)
            => Value.FromHandle<ConstantFP>(LLVM.ConstReal(this.DoubleType.GetTypeRef(), constValue))!;
        ...
        {
            return BasicBlock.FromHandle(LLVM.CreateBasicBlockInContext(this.ContextHandle, name.AsMarshaledString()))!;
        }
        ...
        {
            return LLVM.GetMDKindIDInContext(this.ContextHandle, name.AsMarshaledString(), name == default ? 0u : (uint)name.Length);
        }
        ...
        */
        ...
        internal BitcodeModule GetModuleFor(LLVMModuleRef moduleRef)
        {
            ...
            if (hModuleContext != this.ContextHandle)
            {
                throw new ArgumentException();
            }
        ...
        protected override void Dispose(bool disposing)
        {
            ...
            var handles = from m in this.Modules
