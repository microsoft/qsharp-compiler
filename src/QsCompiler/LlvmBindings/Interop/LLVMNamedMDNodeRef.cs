...
namespace LlvmBindings.Interop
{
    public unsafe partial struct LLVMNamedMDNodeRef : IEquatable<LLVMNamedMDNodeRef>
    {
        ...
        public override bool Equals(object obj) => (obj is LLVMNamedMDNodeRef other) && this.Equals(other);

        public bool Equals(LLVMNamedMDNodeRef other) => this == other;

        public override int GetHashCode() => this.Handle.GetHashCode();

        public override string ToString() => $"{nameof(LLVMNamedMDNodeRef)}: {this.Handle:X}";
    }
}
