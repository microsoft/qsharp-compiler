...
namespace LlvmBindings.Interop
{
    public unsafe partial struct LLVMTargetDataRef : IEquatable<LLVMTargetDataRef>
    {
        ...
        public override bool Equals(object obj) => (obj is LLVMTargetDataRef other) && this.Equals(other);
        ...
        public override string ToString() => $"{nameof(LLVMTargetDataRef)}: {this.Handle:X}";
    }
}
