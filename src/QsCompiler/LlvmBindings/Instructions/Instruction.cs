...
namespace Ubiquity.NET.Llvm.Instructions
{
        ...
        : User
    {
        internal Instruction(LLVMValueRef valueRef)
            : base(valueRef)
        {
            this.Successors = new SuccessorBlockCollection(this);
        }

        /// <summary>Gets the <see cref="BasicBlock"/> that contains this instruction.</summary>
        public BasicBlock ContainingBlock
            => BasicBlock.FromHandle(this.ValueHandle.InstructionParent)!;

        /// <summary>Gets the LLVM opcode for the instruction.</summary>
        public OpCode Opcode => (OpCode)this.ValueHandle.InstructionOpcode;
        ...
        public bool HasMetadata => this.ValueHandle.HasMetadata;
        ...
        {
            get => this.IsMemoryAccess ? LLVM.GetAlignment(this.ValueHandle) : 0;
            ...
            set
            {
                ...
                LLVM.SetAlignment(this.ValueHandle, value);
            }
        }
