...
namespace Ubiquity.NET.Llvm.Values
{
        ...
        : ConstantData
    {
        ...
        public double Value => this.GetValueWithLoss(out bool _);
        ...
        /// </remarks>
        public double GetValueWithLoss(out bool loosesInfo) => this.ValueHandle.GetConstRealDouble(out loosesInfo);
