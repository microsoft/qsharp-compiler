...
namespace Ubiquity.NET.Llvm.Values
{
        ...
        : Value
    {
        ...
        public IrFunction? ContainingFunction
        {
            get
            {
                var parent = this.BlockHandle.Parent;
                if (parent == default)
                {
                    return default;
                }
        ...
        public Instruction? FirstInstruction
        {
            get
            {
                var firstInst = this.BlockHandle.FirstInstruction;
        ...
        public Instruction? LastInstruction
        {
            get
            {
                var lastInst = this.BlockHandle.LastInstruction;
        ...
        public Instruction? Terminator
        {
            get
            {
                var terminator = this.BlockHandle.Terminator;
        ...
        public IEnumerable<Instruction> Instructions
        {
            get
            {
                var current = this.FirstInstruction;
                while (current != default)
                {
                    yield return current;
                    current = this.GetNextInstruction(current);
                }
            }
        }

        internal LLVMBasicBlockRef BlockHandle => this.ValueHandle.AsBasicBlock();
