...
namespace Ubiquity.NET.Llvm.Values
{
    ...
    public class Value
    {
        ...
        public string Name
        {
            get => Context.IsDisposed ? string.Empty : ValueHandle.Name;
        ...
        public bool IsInstruction => ValueHandle.Kind == LLVMValueKind.LLVMInstructionValueKind;

        /// <summary>Gets a value indicating whether the Value is a function</summary>
        public bool IsFunction => ValueHandle.Kind == LLVMValueKind.LLVMFunctionValueKind;
        ...
        public void ReplaceAllUsesWith( Value other )
        {
            ...
            ValueHandle.ReplaceAllUsesWith( other.ValueHandle );
        }
