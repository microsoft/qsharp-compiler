...
namespace LlvmBindings.Values
{
        ...
        : User
    {
        ...
        public bool IsZeroValue => this.ValueHandle.IsAConstantAggregateZero != default;
        ...
        /// <summary>
        /// Creates a constant instance of <paramref name="typeRef"/> with all bits in the instance set to 1.
        /// </summary>
        ...
        /// <summary>
        /// Creates an <see cref="Constant"/> representing an undefined value for <paramref name="typeRef"/>.
        /// </summary>
        ...
        public static Constant UndefinedValueFor(ITypeRef typeRef) =>
            FromHandle<Constant>(typeRef.GetTypeRef().Undef);

        /// <summary>
        /// Creates an <see cref="Constant"/> representing a poison value for <paramref name="typeRef"/>.
        /// </summary>
        /// <param name="typeRef">Type to create the poison value for.</param>
        /// <returns>
        /// <see cref="Constant"/> representing a poison value of <paramref name="typeRef"/>.
        /// </returns>
        public static Constant PoisonValueFor(ITypeRef typeRef) =>
            FromHandle<Constant>(typeRef.GetTypeRef().Poison);
