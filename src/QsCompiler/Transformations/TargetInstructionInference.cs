                        ...
                        else
                        {
                            var specializations = callable.Specializations.Select(spec =>
                            {
                                ...
                                var genCallableType =
                                    ...
                                    ? TypeKind.NewOperation(Tuple.Create(spec.Signature.ArgumentType, spec.Signature.ReturnType), spec.Signature.Information)
                                    : TypeKind.NewFunction(spec.Signature.ArgumentType, spec.Signature.ReturnType);
