...
namespace Microsoft.Quantum.QsCompiler.Transformations.Monomorphization
{
    ...
    public static class Monomorphize
    {
        ...
        //{
        //    var globals = compilation.Namespaces.GlobalCallableResolutions();
        //    var concretizations = new Dictionary<QsQualifiedName, QsCallable>();
        //    var concreteNames = new Dictionary<ConcreteCallGraphNode, QsQualifiedName>();
        ...
        //                .WithSpecializations(specs => specs.Select(spec => spec.WithParent(_ => concreteName)).ToImmutableArray());
        //            concretizations.Add(concreteName, concrete);
        //        }
        //        else
        //        {
        //            concretizations.Add(originalGlobal.FullName, originalGlobal);
        //        }
        //    }

        //    foreach (var name in BuiltIn.RewriteStepDependencies)
        //    {
        //        if (!concretizations.ContainsKey(name))
        //        {
        //            if (!globals.TryGetValue(name, out var originalGlobal))
        //            {
        //                throw new ArgumentException($"Couldn't find definition for callable: {name}");
        //            }
        //            concretizations.Add(name, originalGlobal);
        //        }
        //    }
        ...
        //    {
        //        foreach (var (name, callable) in intrinsicCallableSet)
        //        {
        //            if (!concretizations.ContainsKey(name))
        //            {
        //                concretizations.Add(name, callable);
        //            }
        //        }
        //    }
        ...
        //    var final = ImmutableDictionary.CreateBuilder<QsQualifiedName, QsCallable>();
        //    // Loop through concretizations, replacing all references to generics with their concrete counterparts
        //    foreach (var callable in concretizations)
        //    {
        //        var newCallable = ReplaceTypeParamCalls.Apply(callable, getConcreteIdentifier, intrinsicCallableSet);
        //        final.Add(newCallable.FullName, newCallable);
        //    }
