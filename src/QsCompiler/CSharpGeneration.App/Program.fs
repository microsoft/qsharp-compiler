...
type Options =
    {
        ...
        [<Option('i', "input", Required = true, HelpText = "Q# code or name of the Q# file to compile.")>]
        ...
        [<Option("doc", Required = false, HelpText = "Destination folder where documentation will be generated.")>]
        DocFolder: string
...
type Logger() =
    ...
    override this.OnException ex = Console.Error.WriteLine ex
