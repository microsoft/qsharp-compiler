...
namespace Microsoft.Quantum.QsCompiler
{
    public interface IRewriteStep
    {
        ...
        /// The generated diagnostics will be queried and displayed if either
        /// a) a postcondition verification is implemented and executed, but its execution returned false, or
        /// b) no postcondition verification is implemented, but a transformation is implemented and its execution returned false. 
        /// </summary>
        ...
        /// The generated diagnostics may be queried after the transformation completes 
        /// if the tranformation returns false and no postcondition verification is implemented.  
        /// </summary>
        ...
        /// If the postcondition verification is executed and returns false, the generated diagnostics are queried and displayed to the user. 
