...
namespace Microsoft.Quantum.QsCompiler
{
    public interface IRewriteStep
    {
        ...
        /// <summary>
        /// Folder where any output generated by the rewrite step is be saved. 
        /// The path may be configured prior to executing any of the interface methods. 
        /// If the path is not null, then the set value serve as default. 
        /// </summary>
