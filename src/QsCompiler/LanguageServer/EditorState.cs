...
namespace Microsoft.Quantum.QsLanguageServer
{
    ...
    internal class EditorState : IDisposable
    {
        ...
        /// </summary>
        /// <exception cref="ArgumentException">Thrown if the URI of <paramref name="textDocument"/> is not an absolute file URI.</exception>
        ...
        /// Does nothing if the given file is listed as to be ignored.
        /// </summary>
        /// <exception cref="ArgumentException">Thrown if the URI of the text document identifier in the given parameter is not an absolute file URI.</exception>
        ...
        /// </summary>
        /// <exception cref="ArgumentException">Thrown if the URI of <paramref name="textDocument"/> is null or not an absolute file URI.</exception>
