...
namespace Microsoft.Quantum.QsLanguageServer
{
    ...
    internal static class DotNetSdkHelper
    {
        ...
        private static readonly Regex DotNet5Regex = new Regex(@"^5\.\d+.\d+", RegexOptions.Multiline | RegexOptions.Compiled);

        internal class InstalledVersionsOfDotNetSdk
        {
            public bool DotNetSdk31Installed;
            public bool DotNetSdk5Installed;
        }

        public static InstalledVersionsOfDotNetSdk? GetInstalledVersionsOfDotNetSdks()
        {
            ...
            if (listSdkProcess.WaitForExit(3000))
            {
                ...
                return new InstalledVersionsOfDotNetSdk()
                {
                    DotNetSdk31Installed = DotNet31Regex.IsMatch(sdks),
                    DotNetSdk5Installed = DotNet5Regex.IsMatch(sdks),
                };
            }
            return null;
        }
