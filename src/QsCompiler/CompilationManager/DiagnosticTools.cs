...
namespace Microsoft.Quantum.QsCompiler.CompilationBuilder
{
    public static class DiagnosticTools
    {
        ...
        /// <returns>
        /// The line and character index, or null if the given object is not compatible with the position information generated by this <see cref="CompilationBuilder"/>.
        /// </returns>
        ...
        /// <summary>
        /// Returns a function that returns true if the <see cref="ErrorType"/> of the given <see cref="Diagnostic"/> exists in <paramref name="types"/>.
        /// </summary>
        ...
        /// <summary>
        /// Returns a function that returns true if the <see cref="WarningType"/> of the given <see cref="Diagnostic"/> exists in <paramref name="types"/>.
        /// </summary>
        ...
        /// <summary>
        /// Extracts all elements satisfying <paramref name="condition"/> and which start at a line that is larger or equal to <paramref name="lowerBound"/>.
        /// </summary>
        /// <remarks>
        ...
        /// <summary>
        /// Extracts all elements satisfying <paramref name="condition"/> and which start at a line that is larger or equal to <paramref name="lowerBound"/> and smaller than <paramref name="upperBound"/>.
        /// </summary>
        [return: NotNullIfNotNull("orig")]
        ...
        /// <summary>
        /// Extracts all elements which start at a line that is larger or equal to <paramref name="lowerBound"/> and smaller than <paramref name="upperBound"/>.
        /// </summary>
        [return: NotNullIfNotNull("orig")]
        ...
        /// <summary>
        /// Returns true if the start line of <paramref name="m"/> is larger or equal to <paramref name="lowerBound"/>, and smaller than <paramref name="upperBound"/>.
        /// </summary>
        ...
        /// <summary>
        /// Returns true if the end line of <paramref name="m"/> is larger or equal to <paramref name="lowerBound"/>, and smaller than <paramref name="upperBound"/>.
        /// </summary>
        ...
        /// <summary>
        /// Returns true if the start position of the range of <paramref name="m"/> is contained in <paramref name="range"/>, excluding that
        ...
        /// <summary>
        /// Returns true if the end position of the range of <paramref name="m"/> is contained in <paramref name="range"/>, excluding that
        /// range's end position.
        /// </summary>
