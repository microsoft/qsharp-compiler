...
namespace Microsoft.Quantum.QsCompiler.CompilationBuilder
{
    ...
    internal static class TextProcessor
    {
        ...
        /// </summary>
        /// <exception cref="ArgumentException">Thrown if the code fragment kind of the given fragment is unspecified (i.e. null).</exception>
        ...
        /// </summary>
        /// <exception cref="ArgumentException">Thrown if the file does not have any content.</exception>
        ...
        /// </summary>
        /// <exception cref="ArgumentException">Thrown if the file does not contain any lines.</exception>
        ...
        /// </summary>
        /// <exception cref="ArgumentException">Thrown if the given position is not within file.</exception>
        /// <exception cref="ArgumentException">Thrown if the given position is not smaller than the position after the last piece of code in the file (given by LastInFile).</exception>
        ...
        /// </summary>
        /// <exception cref="ArgumentOutOfRangeException">Thrown if the range [start, start + count) is not a valid range within the current file content.</exception>
