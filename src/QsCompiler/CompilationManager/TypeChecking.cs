    ...
    internal static class TypeChecking
    {
            ...
            NamespaceManager symbols, List<Diagnostic> diagnostics, CancellationToken cancellationToken)
        {
            ...
            QsSpecialization GetSpecialization(SpecializationDeclarationHeader spec, ResolvedSignature signature, 
                ...
                new QsSpecialization(spec.Kind, spec.Parent, spec.Attributes, CapabilityLevel.Unset, CapabilityLevel.Unset, 
                    spec.SourceFile, null, spec.TypeArguments, SyntaxGenerator.WithoutRangeInfo(signature), implementation, spec.Documentation, comments ?? QsComments.Empty);
