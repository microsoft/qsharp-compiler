...
namespace Microsoft.Quantum.QsCompiler.CompilationBuilder
{
    internal static class TypeChecking
    {
        ...
        /// </summary>
        /// <exception cref="ArgumentException">Thrown if the given position is not a valid position within the given file.</exception>
        ...
        /// </summary>
        /// <exception cref="ArgumentException">Thrown if no item precedes the given position.</exception>
        ...
        /// Thrown if the lock for the given compilation cannot be set because a dependent lock is the gating lock ("outermost lock").
        /// </exception>
        /// <exception cref="InvalidOperationException">
        /// Thrown if the given file is not at least read-locked, since the returned token indices will only be valid until the next write
        ...
        /// </summary>
        /// <exception cref="InvalidOperationException">Thrown if the lock for the given compilation cannot be set because a dependent lock is the gating lock ("outermost lock").</exception>
        ...
        /// </summary>
        /// <exception cref="InvalidOperationException">
        /// Thrown if the given file is not at least read-locked, since token indices are only ever valid until the next write operation to the file they are associated with.
        /// </exception>
        ...
        /// </summary>
        /// <exception cref="ArgumentException">Thrown if the given scope context does not currently contain an open scope.</exception>
        ...
        /// Thrown if the given scope context does not currently contain an open scope, or if the repeat header is not followed by a until-success clause.
        /// </exception>
        ...
        /// </summary>
        /// <exception cref="ArgumentException">
        /// Thrown if this is not the case, or if the given scope context does not currently contain an open scope, or if any of the fragments contained in the given nodes is null.
        /// </exception>
        ...
        /// </summary>
        /// <exception cref="ArgumentException">
        /// Thrown if the given root is neither a specialization declaration, nor a callable declaration, or if the callable the specialization
        /// belongs to does not support that specialization according to the given NamespaceManager.
        /// </exception>
        ...
        /// </summary>
        /// <exception cref="ArgumentException">
        /// Thrown if any of the statements contained in the given scope is not annotated with a valid position, or if the given relative position is not a valid position.
        /// </exception>
