...
type LocalVerificationTests () =
    ...
    member this.``Variable declarations`` () = 
        ...
        this.Expect "VariableDeclaration27" [Error ErrorCode.DirectRecursionWithinTemplate]
        //this.Expect "VariableDeclaration28" [Error ErrorCode.DirectRecursionWithinTemplate]
