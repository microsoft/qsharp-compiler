...
type QirDriverGenerationTests(output: ITestOutputHelper) =
    ...
    member this.GenerateCommandLineArguments() =
        ...
        argList.Item(0).Values.Item(0).Integer <- new System.Nullable<int64>(1L)
        argList.Item(1).Name <- "integer-array"
        argList.Item(1).Type <- DataType.ArrayType
        argList.Item(1).ArrayType <- new System.Nullable<DataType>(DataType.IntegerType)
        ...
        argList.Item(2).Values.Item(0).Double <- new System.Nullable<float>(0.5)
        argList.Item(3).Name <- "double-array"
        argList.Item(3).Type <- DataType.ArrayType
        argList.Item(3).ArrayType <- new System.Nullable<DataType>(DataType.DoubleType)
        ...
        argList.Item(4).Values.Item(0).Bool <- new System.Nullable<bool>(true)
        argList.Item(5).Name <- "bool-array"
        argList.Item(5).Type <- DataType.ArrayType
        argList.Item(5).ArrayType <- new System.Nullable<DataType>(DataType.BoolType)
        ...
        argList.Item(6).Values.Item(0).Pauli <- new System.Nullable<PauliValue>(PauliValue.PauliI)
        argList.Item(7).Name <- "pauli-array"
        argList.Item(7).Type <- DataType.ArrayType
        argList.Item(7).ArrayType <- new System.Nullable<DataType>(DataType.PauliType)
        ...
        argList.Item(9).ArrayType <- new System.Nullable<DataType>(DataType.RangeType)
        ...
        argList.Item(10).Values.Item(0).Result <- new System.Nullable<ResultValue>(ResultValue.One)
        argList.Item(11).Name <- "result-array"
        argList.Item(11).Type <- DataType.ArrayType
        argList.Item(11).ArrayType <- new System.Nullable<DataType>(DataType.ResultType)
        ...
        argList.Item(13).ArrayType <- new System.Nullable<DataType>(DataType.StringType)
