define void @Microsoft__Quantum__Intrinsic__K__Ctl____wrapper(%TupleHeader* %capture-tuple, %TupleHeader* %arg-tuple, %TupleHeader* %result-tuple) {
entry:
  ...
  call void @Microsoft__Quantum__Intrinsic__K__Ctl__(%Array* %2, { %TupleHeader, %Qubit*, i64 }* %4)
  ret void
}
