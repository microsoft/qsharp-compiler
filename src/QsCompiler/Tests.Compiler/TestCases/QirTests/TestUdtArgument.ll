...
entry:
  %0 = call %Callable* @__quantum__rt__callable_create([5 x void (%Tuple*, %Tuple*, %Tuple*)*]* @Microsoft__Quantum__Testing__QIR__TestType1, %Tuple* null)
  ...
  %6 = call %Callable* @__quantum__rt__callable_create([5 x void (%Tuple*, %Tuple*, %Tuple*)*]* @Microsoft__Quantum__Testing__QIR__TestType2, %Tuple* null)
  %7 = load i2, i2* @PauliX
  store %Callable* %6, %Callable** %4
  store i2 %7, i2* %5
  %8 = call %Callable* @__quantum__rt__callable_create([5 x void (%Tuple*, %Tuple*, %Tuple*)*]* @PartialApplication__1, %Tuple* %2)
  ...
  %15 = call %Callable* @__quantum__rt__callable_create([5 x void (%Tuple*, %Tuple*, %Tuple*)*]* @Microsoft__Quantum__Testing__QIR__TestType3, %Tuple* null)
  %16 = load i2, i2* @PauliX
  store %Callable* %15, %Callable** %12
  store i2 %16, i2* %13
  store double 2.000000e+00, double* %14
  %17 = call %Callable* @__quantum__rt__callable_create([5 x void (%Tuple*, %Tuple*, %Tuple*)*]* @PartialApplication__2, %Tuple* %10)
  ...
  store i64 -1, i64* %30
  call void @__quantum__rt__callable_memory_management(%Callable* %0, %Tuple* %28, %Tuple* null)
  ...
  call void @__quantum__rt__callable_memory_management(%Callable* %8, %Tuple* %28, %Tuple* null)
  call void @__quantum__rt__callable_update_reference_count(%Callable* %8, i64 -1)
  call void @__quantum__rt__tuple_update_reference_count(%Tuple* %9, i64 -1)
  call void @__quantum__rt__callable_memory_management(%Callable* %17, %Tuple* %28, %Tuple* null)
