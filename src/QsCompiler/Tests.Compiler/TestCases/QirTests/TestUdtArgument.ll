define { %TupleHeader, i64, { %TupleHeader, i2, i64 }* }* @Microsoft__Quantum__Testing__QIR__TestUdtArgument__() #0 {
entry:
  ...
  %udt1 = call i64 @Microsoft__Quantum__Testing__QIR_____GUID___Build__(%Callable* %0)
  %1 = load i2, i2* @PauliX
  ...
  %udt2 = call { %TupleHeader, i2, i64 }* @Microsoft__Quantum__Testing__QIR_____GUID___Build__(%Callable* %7)
  %8 = load i2, i2* @PauliX
  ...
  %udt3 = call { %TupleHeader, { %TupleHeader, i2, i64 }*, double }* @Microsoft__Quantum__Testing__QIR_____GUID___Build__(%Callable* %16)
