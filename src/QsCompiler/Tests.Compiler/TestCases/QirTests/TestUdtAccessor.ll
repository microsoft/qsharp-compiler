...
entry:
  ...
  %2 = load i2, i2* @PauliX
  %3 = getelementptr inbounds { %TupleHeader, i2, i64 }, { %TupleHeader, i2, i64 }* %1, i32 0, i32 1
  store i2 %2, i2* %3
  %4 = getelementptr inbounds { %TupleHeader, i2, i64 }, { %TupleHeader, i2, i64 }* %1, i32 0, i32 2
  store i64 1, i64* %4
