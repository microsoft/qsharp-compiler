...
entry:
  ...
  call void @__quantum__rt__callable_memory_management(i32 1, %Callable* %op, i32 1)
  ...
  call void @__quantum__rt__callable_memory_management(i32 1, %Callable* %op, i32 -1)
  call void @__quantum__rt__callable_update_alias_count(%Callable* %op, i32 -1)
  call void @__quantum__rt__callable_memory_management(i32 0, %Callable* %op, i32 -1)
  call void @__quantum__rt__callable_update_reference_count(%Callable* %op, i32 -1)
  call void @__quantum__rt__callable_memory_management(i32 0, %Callable* %13, i32 -1)
  call void @__quantum__rt__callable_update_reference_count(%Callable* %13, i32 -1)
  call void @__quantum__rt__callable_memory_management(i32 0, %Callable* %19, i32 -1)
  call void @__quantum__rt__callable_update_reference_count(%Callable* %19, i32 -1)
  call void @__quantum__rt__callable_memory_management(i32 0, %Callable* %26, i32 -1)
  call void @__quantum__rt__callable_update_reference_count(%Callable* %26, i32 -1)
  call void @__quantum__rt__callable_memory_management(i32 0, %Callable* %33, i32 -1)
  call void @__quantum__rt__callable_update_reference_count(%Callable* %33, i32 -1)
  call void @__quantum__rt__callable_memory_management(i32 0, %Callable* %39, i32 -1)
  ...
  call void @__quantum__rt__callable_memory_management(i32 0, %Callable* %40, i32 -1)
