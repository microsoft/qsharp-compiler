...
entry:
  ...
  %8 = call %Tuple* @__quantum__rt__tuple_create(i64 ptrtoint ({ { i64, double }*, { %String*, %Qubit* }* }* getelementptr ({ { i64, double }*, { %String*, %Qubit* }* }, { { i64, double }*, { %String*, %Qubit* }* }* null, i32 1) to i64))
  ...
  %12 = call %Tuple* @__quantum__rt__tuple_create(i64 ptrtoint ({ %Array*, { { i64, double }*, { %String*, %Qubit* }* }* }* getelementptr ({ %Array*, { { i64, double }*, { %String*, %Qubit* }* }* }, { %Array*, { { i64, double }*, { %String*, %Qubit* }* }* }* null, i32 1) to i64))
