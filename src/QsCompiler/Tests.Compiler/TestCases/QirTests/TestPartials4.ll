...
entry:
  ...
  call void @__quantum__rt__callable_memory_management(i32 0, %Callable* %10, i32 1)
...
entry:
  ...
  call void @__quantum__rt__callable_memory_management(i32 0, %Callable* %18, i32 1)
...
entry:
  ...
  call void @__quantum__rt__callable_memory_management(i32 0, %Callable* %2, i32 %count-change)
...
entry:
  ...
  %1 = getelementptr inbounds { %Callable*, { i64, double }* }, { %Callable*, { i64, double }* }* %0, i32 0, i32 0
  %2 = load %Callable*, %Callable** %1, align 8
  call void @__quantum__rt__callable_memory_management(i32 1, %Callable* %2, i32 %count-change)
