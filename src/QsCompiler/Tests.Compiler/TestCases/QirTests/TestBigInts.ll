...
entry:
  ...
  call void @__quantum__rt__bigint_update_reference_count(%BigInt* %d, i32 -1)
  call void @__quantum__rt__bigint_update_reference_count(%BigInt* %e, i32 -1)
  call void @__quantum__rt__bigint_update_reference_count(%BigInt* %f, i32 -1)
  call void @__quantum__rt__bigint_update_reference_count(%BigInt* %4, i32 -1)
  call void @__quantum__rt__bigint_update_reference_count(%BigInt* %5, i32 -1)
  call void @__quantum__rt__bigint_update_reference_count(%BigInt* %g, i32 -1)
  ret %BigInt* %6
}
