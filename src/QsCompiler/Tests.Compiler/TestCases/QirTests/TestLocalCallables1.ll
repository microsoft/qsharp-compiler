...
entry:
  ...
  %2 = call %Callable* @__quantum__rt__callable_create([4 x void (%Tuple*, %Tuple*, %Tuple*)*]* @Microsoft__Quantum__Testing__QIR__DoNothing, void (%Tuple*, i64)* null, %Tuple* null)
  ...
  call void @__quantum__rt__callable_memory_management(%Callable* %6, i64 1)
  ...
  call void @__quantum__rt__callable_memory_management(%Callable* %10, i64 1)
  ...
  %fct = call %Callable* @__quantum__rt__callable_create([4 x void (%Tuple*, %Tuple*, %Tuple*)*]* @Microsoft__Quantum__Testing__QIR__ReturnTuple, void (%Tuple*, i64)* null, %Tuple* null)
...
body__1:                                          ; preds = %header__1
  ...
  call void @__quantum__rt__callable_memory_management(%Callable* %37, i64 -1)
...
exit__1:                                          ; preds = %header__1
  ...
  call void @__quantum__rt__callable_memory_management(%Callable* %fct, i64 -1)
