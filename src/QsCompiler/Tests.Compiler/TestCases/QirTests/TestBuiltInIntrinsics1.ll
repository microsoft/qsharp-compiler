...
entry:
  ...
  %10 = call %Callable* @__quantum__rt__callable_create([4 x void (%Tuple*, %Tuple*, %Tuple*)*]* @Microsoft__Quantum__Diagnostics__DumpMachine__FunctionTable, [2 x void (%Tuple*, i32)*]* null, %Tuple* null)
  %11 = load %Callable*, %Callable** %9, align 8
  store %Callable* %10, %Callable** %9, align 8
  ...
  %14 = call %Callable* @__quantum__rt__callable_create([4 x void (%Tuple*, %Tuple*, %Tuple*)*]* @Microsoft__Quantum__Diagnostics__DumpMachine__FunctionTable, [2 x void (%Tuple*, i32)*]* null, %Tuple* null)
  %15 = load %Callable*, %Callable** %13, align 8
  store %Callable* %14, %Callable** %13, align 8
