...
exit__2:                                          ; preds = %header__2
  ...
  call void @__quantum__rt__string_update_reference_count(%String* %45, i32 -1)
  %68 = call %String* @__quantum__rt__string_create(i8* getelementptr inbounds ([2 x i8], [2 x i8]* @5, i32 0, i32 0))
  ...
  %70 = call %String* @__quantum__rt__result_to_string(%Result* %46)
  ...
  %72 = call %String* @__quantum__rt__string_create(i8* getelementptr inbounds ([2 x i8], [2 x i8]* @6, i32 0, i32 0))
  ...
  %74 = call %String* @__quantum__rt__range_to_string(%Range %47)
  ...
  %85 = call %String* @__quantum__rt__string_create(i8* getelementptr inbounds ([2 x i8], [2 x i8]* @9, i32 0, i32 0))
  ...
  %89 = call %String* @__quantum__rt__string_create(i8* getelementptr inbounds ([2 x i8], [2 x i8]* @10, i32 0, i32 0))
  ...
  %92 = call %String* @__quantum__rt__string_create(i8* getelementptr inbounds ([2 x i8], [2 x i8]* @11, i32 0, i32 0))
