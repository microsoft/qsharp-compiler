...
extern "C" void UseIntegerArrayArgWithValues( // NOLINT
    InteropArray* vIntegerArrayArgInteropValue
);
...
int main(int argc, char* argv[])
{
    ...
    vector<int64_t> vIntegerArrayArgCliValue;
    app.add_option("--IntegerArrayArg", vIntegerArrayArgCliValue, "A integer array value for the IntegerArrayArg argument")->required();
    ...
    unique_ptr<InteropArray> vIntegerArrayArgInteropValue = CreateInteropArray(vIntegerArrayArgCliValue);
    ...
    UseIntegerArrayArgWithValues(
        vIntegerArrayArgInteropValue.get()
    );
