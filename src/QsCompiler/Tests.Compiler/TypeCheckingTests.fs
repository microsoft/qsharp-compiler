...
type TypeCheckingTests (output:ITestOutputHelper) =
    ...
    member this.``Common base type`` () = 
        ...
        this.Expect "CommonBaseType2"  [Error ErrorCode.ArgumentMismatchInBinaryOp; Error ErrorCode.ArgumentMismatchInBinaryOp]
        this.Expect "CommonBaseType3"  [Error ErrorCode.ArgumentMismatchInBinaryOp; Error ErrorCode.ArgumentMismatchInBinaryOp]
    ...
    member this.``Argument matching`` () = 
        ...
        this.Expect "MatchArgument10" [Error ErrorCode.AmbiguousTypeParameterResolution; Error ErrorCode.AmbiguousTypeParameterResolution]
    ...
    member this.``Partial application`` () = 
        ...
        this.Expect "PartialApplication15" [Error ErrorCode.ArgumentTypeMismatch; Error ErrorCode.ArgumentTypeMismatch]
