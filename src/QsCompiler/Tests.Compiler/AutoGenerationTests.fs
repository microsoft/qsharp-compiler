...
type FunctorAutoGenTests (output:ITestOutputHelper) =
    ...
    member this.``Feasibility check`` () = 
        ...
        this.Expect "NeedsFunctorSupport18" [Error ErrorCode.MissingFunctorForAutoGeneration]
        this.Expect "NeedsFunctorSupport19" [Error ErrorCode.MissingFunctorForAutoGeneration]
        this.Expect "NeedsFunctorSupport20" [Error ErrorCode.MissingFunctorForAutoGeneration]
