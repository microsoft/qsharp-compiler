...
type LinkingTests() =
    ...
    member this.``Entry point argument and return type verification``() =
        let expect name diagnostics =
            Warning WarningCode.EntryPointInLibrary :: diagnostics |> this.Expect name

        expect "InvalidEntryPoint1" [ Error ErrorCode.QubitTypeInEntryPointSignature ]
        expect "InvalidEntryPoint2" [ Error ErrorCode.InnerTupleInEntryPointArgument ]
        expect "InvalidEntryPoint3" [ Error ErrorCode.QubitTypeInEntryPointSignature ]
        expect "InvalidEntryPoint4" [ Error ErrorCode.QubitTypeInEntryPointSignature ]
        expect "InvalidEntryPoint5" [ Error ErrorCode.QubitTypeInEntryPointSignature ]
        expect "InvalidEntryPoint6" [ Error ErrorCode.QubitTypeInEntryPointSignature ]

        expect "InvalidEntryPoint7" [ Error ErrorCode.CallableTypeInEntryPointSignature ]
        expect "InvalidEntryPoint8" [ Error ErrorCode.InnerTupleInEntryPointArgument ]
        expect "InvalidEntryPoint9" [ Error ErrorCode.InnerTupleInEntryPointArgument ]
        ...
        expect "InvalidEntryPoint15" [ Error ErrorCode.CallableTypeInEntryPointSignature ]
        expect "InvalidEntryPoint16" [ Error ErrorCode.CallableTypeInEntryPointSignature ]

        expect "InvalidEntryPoint17" [ Error ErrorCode.CallableTypeInEntryPointSignature ]
        expect "InvalidEntryPoint18" [ Error ErrorCode.InnerTupleInEntryPointArgument ]
        expect "InvalidEntryPoint19" [ Error ErrorCode.InnerTupleInEntryPointArgument ]
        ...
        expect "InvalidEntryPoint23" [ Error ErrorCode.CallableTypeInEntryPointSignature ]
        ...
        expect "InvalidEntryPoint27" [ Error ErrorCode.UserDefinedTypeInEntryPointSignature ]
        expect "InvalidEntryPoint28" [ Error ErrorCode.InnerTupleInEntryPointArgument ]
        expect "InvalidEntryPoint29" [ Error ErrorCode.UserDefinedTypeInEntryPointSignature ]
        expect "InvalidEntryPoint30" [ Error ErrorCode.UserDefinedTypeInEntryPointSignature ]
        expect "InvalidEntryPoint31" [ Error ErrorCode.UserDefinedTypeInEntryPointSignature ]
        expect "InvalidEntryPoint32" [ Error ErrorCode.UserDefinedTypeInEntryPointSignature ]
        ...
        expect "InvalidEntryPoint37" [ Error ErrorCode.InnerTupleInEntryPointArgument ]
        expect "InvalidEntryPoint38" [ Error ErrorCode.InnerTupleInEntryPointArgument ]
        expect "InvalidEntryPoint39" [ Error ErrorCode.ArrayOfArrayInEntryPointArgument ]
        expect "InvalidEntryPoint40" [ Error ErrorCode.ArrayOfArrayInEntryPointArgument ]
        expect "InvalidEntryPoint41" [ Error ErrorCode.ArrayOfArrayInEntryPointArgument ]
