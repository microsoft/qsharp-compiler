...
let private createArrayArgumentValue (arrayValue: List<ArgumentValue>) =
    new ArgumentValue(Array = arrayValue)
...
let private createArrayArgument (name: string,
                         arrayType: DataType,
                         position: int32) =
...
let private createExecutionInformation(entryPoint: EntryPointOperation, argumentValues: Dictionary<string, ArgumentValue>) =
    ...
    Map
        ...
        .Add("UseBoolArgWithValues",
            createExecutionInformation(
                createEntryPointOperation(
                    ...
                    [createArgument("BoolArg", DataType.BoolType, 0)]),
        ...
        .Add("UseBoolArrayArgWithValues",
            createExecutionInformation(
                createEntryPointOperation(
                    ...
                    [createArrayArgument("BoolArrayArg", DataType.BoolType, 0)]),
                createArgumentMap("BoolArrayArg", createBoolArrayArgumentValue(
                    [ new System.Nullable<bool>(true); System.Nullable<bool>(false); System.Nullable<bool>(true) ]
                ))))
        .Add("UseIntegerArrayArgWithValues",
            createExecutionInformation(
                ...
                createArgumentMap("IntegerArrayArg", createIntegerArrayArgumentValue(
                    [ new System.Nullable<int64>(int64(999)); System.Nullable<int64>(int64(-1)); System.Nullable<int64>(int64(11)) ]
                ))))
        .Add("UseDoubleArrayArgWithValues",
            createExecutionInformation(
                createEntryPointOperation(
                    "UseDoubleArrayArgWithValues",
                    [createArrayArgument("DoubleArrayArg", DataType.DoubleType, 0)]),
                createArgumentMap("DoubleArrayArg", createDoubleArrayArgumentValue(
                    [ new System.Nullable<double>(3.14159); System.Nullable<double>(0.55); System.Nullable<double>(1024.333); System.Nullable<double>(-8192.667); ]
                ))))
        .Add("UsePauliArrayArgWithValues",
            createExecutionInformation(
                createEntryPointOperation(
                    "UsePauliArrayArgWithValues",
                    [createArrayArgument("PauliArrayArg", DataType.PauliType, 0)]),
                createArgumentMap("PauliArrayArg", createPauliArrayArgumentValue(
                    [ new System.Nullable<PauliValue>(PauliValue.PauliI); new System.Nullable<PauliValue>(PauliValue.PauliX); new System.Nullable<PauliValue>(PauliValue.PauliY); new System.Nullable<PauliValue>(PauliValue.PauliZ) ]
                ))))
        .Add("UseRangeArrayArgWithValues",
            createExecutionInformation(
                createEntryPointOperation(
                    "UseRangeArrayArgWithValues",
                    [createArrayArgument("RangeArrayArg", DataType.RangeType, 0)]),
                createArgumentMap("RangeArrayArg", createRangeArrayArgumentValue(
        ...
        .Add("UseResultArrayArgWithValues",
            createExecutionInformation(
                createEntryPointOperation(
                    ...
                    [createArrayArgument("ResultArrayArg", DataType.ResultType, 0)]),
                createArgumentMap("ResultArrayArg", createResultArrayArgumentValue(
                    [ new System.Nullable<ResultValue>(ResultValue.One); new System.Nullable<ResultValue>(ResultValue.Zero) ]
                ))))
        .Add("UseMiscArgs",
            createExecutionInformation(
                createEntryPointOperation(
                ...
                createMultiArgumentMap(
                    ...
                    [new ArgumentValue(Integer = int64(30)); new ArgumentValue(String = "String value")])))
