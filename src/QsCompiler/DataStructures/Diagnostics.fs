    ...
    static member Message(code: ErrorCode, args: IEnumerable<string>) =
        let ApplyArguments =
            ...
            << function
                ...
                | ErrorCode.MissingPrecedingIfOrElif ->
                    "An elif- or else-block must be preceded by an if- or elif-block."
                ...
                | ErrorCode.InaccessibleType ->
                    "The type {0} exists in an open namespace, but is not accessible from here."
                ...
                | ErrorCode.RedefinitionOfAdjoint ->
                    "An adjoint specialization for the given parameters already exists."
                ...
                | ErrorCode.InterpolatedStringInAttribute ->
                    "Interpolated strings cannot be used as attribute arguments."
                ...
                | ErrorCode.EntryPointInLibrary ->
                    "Invalid entry point. Only executable Q# projects can have entry points."
                ...
                | ErrorCode.TypeLessAccessibleThanParentType ->
                    "The type {0} is less accessible than the parent type {1}."
                | ErrorCode.TypeLessAccessibleThanParentCallable ->
                    "The type {0} is less accessible than the callable {1}."
                ...
                | ErrorCode.UnknownProjectReference ->
                    "Could not find the project file for the referenced project \"{0}\"."
                ...
                | ErrorCode.InvalidCommandLineArgsInResponseFiles ->
                    "Invalid command line arguments in response file(s)."
                ...
                | ErrorCode.PluginExecutionFailed ->
                    "The compilation step \"{0}\" loaded from \"{1}\" threw an exception."
        ...
        let ApplyArguments =
            ...
            << function
                ...
                | WarningCode.DeprecatedNOToperator ->
                    "Deprecated syntax. Use \"not\" to denote the logical NOT operator."
                | WarningCode.DeprecatedANDoperator ->
                    "Deprecated syntax. Use \"and\" to denote the logical AND operator."
                | WarningCode.DeprecatedORoperator -> "Deprecated syntax. Use \"or\" to denote the logical OR operator."
                | WarningCode.UseOfFutureReservedKeyword ->
                    "The symbol will be reserved for internal use in the future."
                ...
                | WarningCode.DuplicateSourceFile ->
                    "A source file with name \"{0}\" already exists in the compilation."
                ...
                | WarningCode.DuplicateBinaryFile ->
                    "A binary file with name \"{0}\" already exists in the compilation."
