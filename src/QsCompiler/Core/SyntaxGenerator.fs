...
type private StripPositionInfoFromExpression () = 
    ...
    override this.onRangeInformation _ = Null
    override this.Types = typeTransformation
...
type private StripPositionInfoFromScope() = 
    ...
    override this.Expression = expressionTransformation :> ExpressionTransformationBase
...
type public StripPositionInfo() = 
    ...
    static member public Apply t = defaultInstance.Scope.Expression.Types.Transform t
