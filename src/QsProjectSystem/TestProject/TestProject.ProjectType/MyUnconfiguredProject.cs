...
namespace MS.Quantum.ProjectSystem
{
    using System;
    ...
    [ProjectTypeRegistration(VsPackage.ProjectTypeGuid, "Q# Library", "#2", ProjectExtension, Language, resourcePackageGuid: VsPackage.PackageGuid, PossibleProjectExtensions = ProjectExtension)]
    internal class MyUnconfiguredProject
    {
        ...
        /// </remarks>
        internal const string UniqueCapability = "TestProject";
