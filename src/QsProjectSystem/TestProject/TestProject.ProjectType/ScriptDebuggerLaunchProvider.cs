...
namespace MS.Quantum.ProjectSystem
{
    ...
    public class ScriptDebuggerLaunchProvider : DebugLaunchProviderBase
    {
        ...
        [ExportPropertyXamlRuleDefinition("MS.Quantum.ProjectSystem, Version=1.0.0.0, Culture=neutral, PublicKeyToken=9be6e469bc4921f1", "XamlRuleToCode:ScriptDebugger.xaml", "Project")]
        [AppliesTo(MyUnconfiguredProject.UniqueCapability)]
