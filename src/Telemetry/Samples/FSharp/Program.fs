...
[<Struct>]
type ExecutionCompleted(?sampleDateTime: DateTime,
                        ?sampleString : string,
                        ?sampleBool : bool,
...
let main args =
    try 
        ...
        try 
            ...
            let eventProperties = 
                Microsoft.Applications.Events.EventProperties(
                    Name = "SampleEvent"
                )
            ...
            eventProperties.SetProperty("SamplePIIData", "username", Microsoft.Applications.Events.PiiKind.Identity) |> ignore
