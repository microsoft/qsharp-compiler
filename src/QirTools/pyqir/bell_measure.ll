...
entry:
  ...
  %qc = call %Array* @__quantum__rt__array_create_1d(i32 8, i64 2)
  %qc_0_raw = call i8* @__quantum__rt__array_get_element_ptr_1d(%Array* %qc, i64 0)
  %qc_result_0 = bitcast i8* %qc_0_raw to %Result**
  ...
  store %Result* %zero_0, %Result** %qc_result_0, align 8
  %qc_1_raw = call i8* @__quantum__rt__array_get_element_ptr_1d(%Array* %qc, i64 1)
  %qc_result_1 = bitcast i8* %qc_1_raw to %Result**
  ...
  store %Result* %zero_1, %Result** %qc_result_1, align 8
  ...
  store %Array* %qc, %Array** %results_result_tmp_result_0, align 8
  call void @Microsoft__Quantum__Intrinsic__H__body(%Qubit* %qr0)
  ...
  store %Qubit* %qr0, %Qubit** %__controlQubits__0_result_tmp_result_0, align 8
  call void @Microsoft__Quantum__Intrinsic__X__ctl(%Array* %__controlQubits__, %Qubit* %qr1)
  call void @__quantum__rt__array_update_reference_count(%Array* %__controlQubits__, i32 -1)
  %measurement = call %Result* @Microsoft__Quantum__Intrinsic__M__body(%Qubit* %qr0)
  %qc0_0_raw = call i8* @__quantum__rt__array_get_element_ptr_1d(%Array* %qc, i64 0)
  %qc0_result_0 = bitcast i8* %qc0_0_raw to %Result**
  %existing_value = load %Result*, %Result** %qc0_result_0, align 8
  ...
  store %Result* %measurement, %Result** %qc0_result_0, align 8
  %measurement1 = call %Result* @Microsoft__Quantum__Intrinsic__M__body(%Qubit* %qr1)
  %qc1_1_raw = call i8* @__quantum__rt__array_get_element_ptr_1d(%Array* %qc, i64 1)
  %qc1_result_1 = bitcast i8* %qc1_1_raw to %Result**
  %existing_value2 = load %Result*, %Result** %qc1_result_1, align 8
  ...
  store %Result* %measurement1, %Result** %qc1_result_1, align 8
