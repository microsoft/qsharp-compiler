...
source_filename = "C:\\Users\\iadavis\\dev\\qsharp-compiler\\src\\QirTools\\pyqir\\qirlib\\src\\emit\\qir\\module.ll"
...
entry:
  %input0 = call %Qubit* @__quantum__rt__qubit_allocate()
  %input1 = call %Qubit* @__quantum__rt__qubit_allocate()
  %input2 = call %Qubit* @__quantum__rt__qubit_allocate()
  %input3 = call %Qubit* @__quantum__rt__qubit_allocate()
  %input4 = call %Qubit* @__quantum__rt__qubit_allocate()
  %target0 = call %Qubit* @__quantum__rt__qubit_allocate()
  %results = call %Array* @__quantum__rt__array_create_1d(i32 8, i64 1)
  %output = call %Array* @__quantum__rt__array_create_1d(i32 8, i64 5)
  ...
  call void @Microsoft__Quantum__Intrinsic__H__body(%Qubit* %input0)
  call void @Microsoft__Quantum__Intrinsic__H__body(%Qubit* %input1)
  call void @Microsoft__Quantum__Intrinsic__H__body(%Qubit* %input2)
  call void @Microsoft__Quantum__Intrinsic__H__body(%Qubit* %input3)
  call void @Microsoft__Quantum__Intrinsic__H__body(%Qubit* %input4)
  ...
  store %Qubit* %input1, %Qubit** %__controlQubits__0_result_tmp_result_0, align 8
  ...
  store %Qubit* %input3, %Qubit** %__controlQubits__0_result_tmp_result_03, align 8
  ...
  store %Qubit* %input4, %Qubit** %__controlQubits__0_result_tmp_result_06, align 8
  call void @Microsoft__Quantum__Intrinsic__X__ctl(%Array* %__controlQubits__4, %Qubit* %target0)
  ...
  call void @Microsoft__Quantum__Intrinsic__H__body(%Qubit* %input3)
  call void @Microsoft__Quantum__Intrinsic__H__body(%Qubit* %input4)
  %measurement = call %Result* @Microsoft__Quantum__Intrinsic__M__body(%Qubit* %input0)
  ...
  %measurement7 = call %Result* @Microsoft__Quantum__Intrinsic__M__body(%Qubit* %input1)
  ...
  %existing_value8 = load %Result*, %Result** %output1_result_1, align 8
  call void @__quantum__rt__result_update_reference_count(%Result* %existing_value8, i32 -1)
  call void @__quantum__rt__result_update_reference_count(%Result* %measurement7, i32 1)
  store %Result* %measurement7, %Result** %output1_result_1, align 8
  %measurement9 = call %Result* @Microsoft__Quantum__Intrinsic__M__body(%Qubit* %input2)
  ...
  %existing_value10 = load %Result*, %Result** %output2_result_2, align 8
  ...
  store %Result* %measurement9, %Result** %output2_result_2, align 8
  %measurement11 = call %Result* @Microsoft__Quantum__Intrinsic__M__body(%Qubit* %input3)
  ...
  %existing_value12 = load %Result*, %Result** %output3_result_3, align 8
  ...
  store %Result* %measurement11, %Result** %output3_result_3, align 8
  %measurement13 = call %Result* @Microsoft__Quantum__Intrinsic__M__body(%Qubit* %input4)
  ...
  %existing_value14 = load %Result*, %Result** %output4_result_4, align 8
  ...
  store %Result* %measurement13, %Result** %output4_result_4, align 8
  call void @__quantum__rt__qubit_release(%Qubit* %input0)
  call void @__quantum__rt__qubit_release(%Qubit* %input3)
  call void @__quantum__rt__qubit_release(%Qubit* %target0)
  call void @__quantum__rt__qubit_release(%Qubit* %input2)
  call void @__quantum__rt__qubit_release(%Qubit* %input1)
  call void @__quantum__rt__qubit_release(%Qubit* %input4)
  ret %Array* %results
}
