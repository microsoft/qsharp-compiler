...
TransformationRulesPass::TransformationRulesPass(RuleSet &&rule_set,
...
bool TransformationRulesPass::runOnFunction(llvm::Function &           function,
...
void TransformationRulesPass::runDetectActiveCode(llvm::Module &module,
...
llvm::PreservedAnalyses TransformationRulesPass::run(llvm::Module &               module,
...
llvm::Function *TransformationRulesPass::expandFunctionCall(llvm::Function &         callee,
