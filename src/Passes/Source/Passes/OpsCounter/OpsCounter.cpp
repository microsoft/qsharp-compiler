...
namespace microsoft {
namespace quantum {
OpsCounterAnalytics::Result OpsCounterAnalytics::run(llvm::Function &function,
                                                     llvm::FunctionAnalysisManager & /*unused*/)
{
  ...
  for (auto &basic_block : function)
  {
    ...
    {
      /*
      TODO(tfr): Enbale in LLVM 12 or later
...
llvm::PreservedAnalyses OpsCounterPrinter::run(llvm::Function &               function,
