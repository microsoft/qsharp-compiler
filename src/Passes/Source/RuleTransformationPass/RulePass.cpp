...
RuleTransformationPass::RuleTransformationPass(RuleSet &&                                 rule_set,
...
bool RuleTransformationPass::runOnFunction(llvm::Function &           function,
...
void RuleTransformationPass::runDetectActiveCode(llvm::Module &module,
...
llvm::PreservedAnalyses RuleTransformationPass::run(llvm::Module &               module,
...
llvm::Function *RuleTransformationPass::expandFunctionCall(llvm::Function &         callee,
