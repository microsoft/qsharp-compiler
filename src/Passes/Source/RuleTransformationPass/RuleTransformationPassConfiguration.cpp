...
namespace quantum
{
    ...
    RuleTransformationPassConfiguration RuleTransformationPassConfiguration::createDisabled()
    {
    ...
    bool RuleTransformationPassConfiguration::shouldSimplifyPriorTransform() const
    {
        return simplify_prior_transformation_;
    }

    bool RuleTransformationPassConfiguration::shouldDeleteDeadCode() const
    {
        return delete_dead_code_;
    }

    bool RuleTransformationPassConfiguration::shouldCloneFunctions() const
    {
        return clone_functions_;
    }

    bool RuleTransformationPassConfiguration::shouldTransformExecutionPathOnly() const
    {
    ...
    bool RuleTransformationPassConfiguration::shouldReuseQubits() const
    {
        return reuse_qubits_;
    }

    bool RuleTransformationPassConfiguration::shouldAnnotateQubitUse() const
    {
        return annotate_qubit_use_;
    }

    bool RuleTransformationPassConfiguration::shouldReuseResults() const
    {
        return reuse_results_;
    }

    bool RuleTransformationPassConfiguration::shouldAnnotateResultUse() const
    {
        return annotate_result_use_;
    }

    bool RuleTransformationPassConfiguration::shouldGroupMeasurements() const
    {
