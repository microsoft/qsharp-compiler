...
namespace quantum
{
    ...
    DefaultProfileGenerator::DefaultProfileGenerator()
    {
        ...
        registerProfileComponent<RuleTransformationPassConfiguration>(
            ...
            [](RuleTransformationPassConfiguration const& config, ProfileGenerator* ptr, Profile& profile) {
        ...
        LlvmPassesConfiguration const&             llvm_config)
    {
        ...
        registerProfileComponent<RuleTransformationPassConfiguration>(
            "transformation-rules",
            [configure](RuleTransformationPassConfiguration const& config, ProfileGenerator* ptr, Profile& profile) {
                auto& ret = ptr->modulePassManager();
