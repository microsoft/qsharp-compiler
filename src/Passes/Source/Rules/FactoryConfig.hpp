...
namespace quantum
{
    ...
    struct FactoryConfiguration
    {
        void setup(ConfigurationManager& config)
        {
            ...
            config.addParameter(
                disable_reference_counting, "disable-reference-counting",
            ...
            config.addParameter(
                ...
                "Disables reference counting by instruction removal.");
            config.addParameter(
                disable_alias_counting, "disable-alias-counting", "Disables alias counting by instruction removal.");
            config.addParameter(
                disable_string_support, "disable-string-support", "Disables string support by instruction removal.");
            config.addParameter(
            ...
            config.addParameter(
                ...
                "type measurement.");
            config.addParameter(
                use_static_qubit_array_allocation, "use-static-qubit-array-allocation",
                "Maps allocation of qubit arrays to static array allocation.");
            config.addParameter(
                use_static_qubit_allocation, "use-static-qubit-allocation",
                "Maps qubit allocation to static allocation.");
            config.addParameter(
                use_static_result_allocation, "use-static-result-allocation",
