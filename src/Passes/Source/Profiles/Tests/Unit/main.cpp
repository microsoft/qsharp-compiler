...
TEST(ProfileTestSuite, Teleportation)
{
  ProfileTest input(R"script(
...
continue__1:                                      ; preds = %then0__1, %entry
  %3 = call %Result* @Microsoft__Quantum__Measurement__MResetZ__body.2(%Qubit* %intermediary)
...
entry:
  ...
  %27 = call %Result* @Microsoft__Quantum__Measurement__MResetZ__body.3(%Qubit* %leftMessage)
  ...
  %31 = call %Result* @Microsoft__Quantum__Measurement__MResetZ__body.4(%Qubit* %30)
  call void @__quantum__rt__array_update_alias_count(%Array* %leftPreshared, i32 -1)
  call void @__quantum__rt__array_update_alias_count(%Array* %rightPreshared, i32 -1)
...
entry:
  %0 = call %Result* @TeleportChain__DemonstrateTeleportationUsingPresharedEntanglement__body.5()
...
entry:
  %0 = call %Result* @TeleportChain__DemonstrateTeleportationUsingPresharedEntanglement__body.6()
...
define internal fastcc %Result* @TeleportChain__DemonstrateTeleportationUsingPresharedEntanglement__body.5() unnamed_addr {
entry:
  %leftMessage = call %Qubit* @__quantum__rt__qubit_allocate()
  %rightMessage = call %Qubit* @__quantum__rt__qubit_allocate()
  %leftPreshared = call %Array* @__quantum__rt__qubit_allocate_array(i64 2)
  ...
  %26 = load %Qubit*, %Qubit** %25, align 8
  call fastcc void @TeleportChain__TeleportQubitUsingPresharedEntanglement__body(%Qubit* %20, %Qubit* %23, %Qubit* %26)
  %27 = call %Result* @Microsoft__Quantum__Measurement__MResetZ__body.3.7(%Qubit* %leftMessage)
  %28 = call i8* @__quantum__rt__array_get_element_ptr_1d(%Array* %rightPreshared, i64 1)
  %29 = bitcast i8* %28 to %Qubit**
  %30 = load %Qubit*, %Qubit** %29, align 8
  %31 = call %Result* @Microsoft__Quantum__Measurement__MResetZ__body.4.8(%Qubit* %30)
  call void @__quantum__rt__array_update_alias_count(%Array* %leftPreshared, i32 -1)
  call void @__quantum__rt__array_update_alias_count(%Array* %rightPreshared, i32 -1)
  call void @__quantum__rt__result_update_reference_count(%Result* %27, i32 -1)
  call void @__quantum__rt__qubit_release(%Qubit* %leftMessage)
...
define internal fastcc %Result* @TeleportChain__DemonstrateTeleportationUsingPresharedEntanglement__body.6() unnamed_addr {
entry:
  %leftMessage = call %Qubit* @__quantum__rt__qubit_allocate()
  %rightMessage = call %Qubit* @__quantum__rt__qubit_allocate()
  %leftPreshared = call %Array* @__quantum__rt__qubit_allocate_array(i64 2)
  ...
  %26 = load %Qubit*, %Qubit** %25, align 8
  call fastcc void @TeleportChain__TeleportQubitUsingPresharedEntanglement__body(%Qubit* %20, %Qubit* %23, %Qubit* %26)
  %27 = call %Result* @Microsoft__Quantum__Measurement__MResetZ__body.3.9(%Qubit* %leftMessage)
  %28 = call i8* @__quantum__rt__array_get_element_ptr_1d(%Array* %rightPreshared, i64 1)
  %29 = bitcast i8* %28 to %Qubit**
  %30 = load %Qubit*, %Qubit** %29, align 8
  %31 = call %Result* @Microsoft__Quantum__Measurement__MResetZ__body.4.10(%Qubit* %30)
  call void @__quantum__rt__array_update_alias_count(%Array* %leftPreshared, i32 -1)
  call void @__quantum__rt__array_update_alias_count(%Array* %rightPreshared, i32 -1)
  call void @__quantum__rt__result_update_reference_count(%Result* %27, i32 -1)
  call void @__quantum__rt__qubit_release(%Qubit* %leftMessage)
...
attributes #1 = { "EntryPoint" }
  ...
  profile->addFunctionAnalyses(input.functionAnalysisManager());
  auto module_pass_manager =
      profile->createGenerationModulePass(input.passBuilder(), optimisation_level, debug);

  // Running the pass built by the profile
  module_pass_manager.run(*module, input.moduleAnalysisManager());
}
