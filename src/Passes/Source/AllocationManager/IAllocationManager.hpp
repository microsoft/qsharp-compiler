...
namespace quantum
{
    ...
    class IAllocationManager
    {
      public:
        ...
        using Index                = uint64_t;    ///< Index type used to acccess an array element.
        ...
        /// should not assume continuity of the address segment as this is not garantued. Note this
        ...
        /// Current number of registers in use. This function is used to enquire about tye current number
