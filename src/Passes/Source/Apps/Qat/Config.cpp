...
void QatConfig::setup(ConfigurationManager &config)
{
  ...
  config.addParameter(generate_, "generate",
                      "Transforms the IR in correspondence with the specified transformation.");
  ...
  config.addParameter(dump_config_, "dump-config",
