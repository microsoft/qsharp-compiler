...
int main(int argc, char **argv)
{
  try
  {
    ...
    generator->registerProfileComponent<
        LlvmPassesConfiguration>("llvm-passes", [](LlvmPassesConfiguration const &cfg,
...

      {
        ...
        if (!pass_builder.parsePassPipeline(npm, PassPipeline, false, false))
        {
