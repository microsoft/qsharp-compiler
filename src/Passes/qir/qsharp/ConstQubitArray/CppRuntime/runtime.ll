...
define i8* @__quantum__rt__tuple_create(i64 %0) #0 {
  ...
  %8 = add i64 %7, 24
  %9 = call noalias nonnull i8* @_Znam(i64 %8) #6
...
define void @__quantum__rt__tuple_update_reference_count(i8* %0, i32 %1) #2 {
  %3 = alloca i8*, align 8
...
define %class.Array* @__quantum__rt__array_create_1d(i32 %0, i64 %1) #0 {
  ...
  call void @_ZN5ArrayC1Exx(%class.Array* %6, i64 %8, i64 %9) #8
  ret %class.Array* %6
}
...
define linkonce_odr void @_ZN5ArrayC1Exx(%class.Array* %0, i64 %1, i64 %2) unnamed_addr #2 align 2 {
  ...
  call void @_ZN5ArrayC2Exx(%class.Array* %7, i64 %8, i64 %9) #8
  ret void
}
...
5:                                                ; preds = %1
  call void @_ZN5ArrayD1Ev(%class.Array* %3) #8
...
define linkonce_odr void @_ZN5ArrayD1Ev(%class.Array* %0) unnamed_addr #2 align 2 {
  ...
  store %class.Array* %0, %class.Array** %2, align 8
  %3 = load %class.Array*, %class.Array** %2, align 8
  call void @_ZN5ArrayD2Ev(%class.Array* %3) #8
  ret void
}
...
18:                                               ; preds = %13, %10
  ...
  call void @_ZN5ArrayC1EPS_(%class.Array* %20, %class.Array* %21) #8
...
define linkonce_odr void @_ZN5ArrayC1EPS_(%class.Array* %0, %class.Array* %1) unnamed_addr #2 align 2 {
  ...
  call void @_ZN5ArrayC2EPS_(%class.Array* %5, %class.Array* %6) #8
  ret void
}
...
define linkonce_odr void @_ZN5ArrayC2Exx(%class.Array* %0, i64 %1, i64 %2) unnamed_addr #2 align 2 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
  ...
  %9 = call nonnull align 8 dereferenceable(8) i64* @_ZNSt3__14moveIRxEEONS_16remove_referenceIT_E4typeEOS3_(i64* nonnull align 8 dereferenceable(8) %5) #8
  %10 = load i64, i64* %9, align 8
  store i64 %10, i64* %8, align 8
  %11 = getelementptr inbounds %class.Array, %class.Array* %7, i32 0, i32 1
  %12 = call nonnull align 8 dereferenceable(8) i64* @_ZNSt3__14moveIRxEEONS_16remove_referenceIT_E4typeEOS3_(i64* nonnull align 8 dereferenceable(8) %6) #8
