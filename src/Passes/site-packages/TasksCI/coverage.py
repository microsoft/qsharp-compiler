...
def main(build_dir: str, output_dir: Union[str, None] = None, output_format="html"):
    """
    ...
    for exe in test_executables:
        ...
        # Generating index
        try:
            cmd1 = [toolchain.discover_profdata(), "merge", "-sparse", profile_file, "-o", index_file]
        ...
        try:
            cmd2 = [toolchain.discover_llvm_cov(), "show",
                    ...
                    "-instr-profile=" + index_file, "-format={}".format(output_format), "-o",
                    current_output_dir]
    ...
    summary_index_file = os.path.abspath(os.path.join(build_dir, "summary.profdata"))
    ...
    cmd = [toolchain.discover_llvm_cov(), "show",
           "-ignore-filename-regex=\".*(vendors|llvm|Tests).*\"",
           "-Xdemangler", "c++filt"] + all_binaries + [
        "-instr-profile=" + summary_index_file, "-format={}".format(output_format), "-o",
        current_output_dir]
