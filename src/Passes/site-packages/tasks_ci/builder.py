...
def configure_cmake(build_dir: str, generator=None, cmake_flags: Optional[List[str]] = None) -> None:
    """
...
def main(build_dir: str, generator: OptionalStr = None, test: bool = False, cmake_flags: List[str] = []) -> None:
    """
