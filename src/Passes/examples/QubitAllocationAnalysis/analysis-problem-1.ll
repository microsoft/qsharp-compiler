...
entry:
  call fastcc void @Example__QuantumFunction__body()
  ret void
}

define internal fastcc void @Example__QuantumFunction__body() unnamed_addr {
entry:
  %qubits = call %Array* @__quantum__rt__qubit_allocate_array(i64 10)
