...
entry:
  %0 = call i64 @Example__QuantumFunction__body(i64 10)
  ret i64 %0
}

define internal i64 @Example__QuantumFunction__body(i64 %nQubits) {
entry:
...
define i64 @Example__Main__Interop() #0 {
entry:
  %0 = call i64 @Example__Main__body()
  ret i64 %0
}

define void @Example__Main() #1 {
entry:
  %0 = call i64 @Example__Main__body()
