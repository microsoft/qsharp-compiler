        ...
        internal static string ToMarkdownLink(this ResolvedType type) => type.Resolution switch
            {
                ...
                _ => type.Resolution.Tag switch
                    {
                        ResolvedTypeKind.Tags.BigInt => "[BigInt](xref:microsoft.quantum.user-guide.language.types)",
                        ResolvedTypeKind.Tags.Bool => "[Bool](xref:microsoft.quantum.user-guide.language.types)",
                        ResolvedTypeKind.Tags.Double => "[Double](xref:microsoft.quantum.user-guide.language.types)",
                        ResolvedTypeKind.Tags.Int => "[Int](xref:microsoft.quantum.user-guide.language.types)",
                        ResolvedTypeKind.Tags.Pauli => "[Pauli](xref:microsoft.quantum.user-guide.language.types)",
                        ResolvedTypeKind.Tags.Qubit => "[Qubit](xref:microsoft.quantum.concepts.the-qubit)",
                        ResolvedTypeKind.Tags.Range => "[Range](xref:microsoft.quantum.user-guide.language.types)",
                        ResolvedTypeKind.Tags.String => "[String](xref:microsoft.quantum.user-guide.language.types)",
                        ResolvedTypeKind.Tags.UnitType => "[Unit](xref:microsoft.quantum.user-guide.language.types)",
